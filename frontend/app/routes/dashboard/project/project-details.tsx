...
import { AlertCircle, Calendar, Check, CheckCircle, Clock, Loader } from "lucide-react";
...
const ProjectDetails = () => {
    ...
    const { data, isLoading, isError } = UseProjectQuery(projectId!) as {
        data: {
            tasks: Task[];
            project: Project;
        };
